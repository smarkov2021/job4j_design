...
class SimpleMapTest {
    ...
    @Test
    void whenCheckAllOperation() {
        assertThat(map).hasSize(4);
        assertThat(map.remove(2)).isTrue();
        assertThat(map.remove(2)).isFalse();
        assertThat(map).hasSize(3);
        assertThat(map.put(2, "123")).isTrue();
        assertThat(map).hasSize(4);
        assertThat(map.put(16, null)).isTrue();
        assertThat(map.put(32, null)).isFalse();
        assertThat(map.put(0, null)).isFalse();
        assertThat(map.remove(16)).isTrue();
